...
const Hero = () => {
    return (
        <section className="mt-32 md:mt-42 content-padding relative">
            <div className="relative bg-[var(--color-light-yellow)] rounded-3xl px-3 md:px-12 pt-12">
                <div className="layout-container flex flex-col md:flex-row-reverse md:gap-16 items-center">
