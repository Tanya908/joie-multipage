...
const Hero = () => {
    return (
        <section className="mt-32 md:mt-40 content-padding relative overflow-hidden">
            <div className="relative rounded-3xl bg-[var(--color-light-yellow)] px-3 md:px-12 xl:px-20 py-12 lg:py-15">
                <div className="layout-container flex flex-col lg:flex-row justify-between items-center">
